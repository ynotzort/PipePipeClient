...
public final class VideoDetailFragment
    ...
    public void onClick(final View v) {
        ...
        } else if (id == R.id.detail_controls_play_on_sonos) {
            playOnSonos(false);
    ...
    protected void initListeners() {
        ...
        binding.detailControlsPlayOnSonos.setOnClickListener(this);
        binding.detailControlsPlayOnSonos.setOnLongClickListener(this);
        if (DEBUG) {
